# Este script agrega los modelos RecetaDinamica, LineaReceta y ParametroProducto
# a productos/models.py
...
import os
filepath = r"productos/models.py"
with open(filepath, "r", encoding="utf-8") as f:
    content = f.read()

if "RecetaDinamica" in content:
    print("RecetaDinamica ya existe en models.py")
else:
    with open(filepath, "a", encoding="utf-8") as f:
        f.write("\n\n" + codigo)
    print("Modelos agregados OK")
